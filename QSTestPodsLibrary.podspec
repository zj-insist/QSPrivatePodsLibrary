...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zj_lostself@163.com/QSTestPodsLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zj_lostself@163.com' => 'zj_lostself@163.com' }
  s.source           = { :git => 'https://github.com/zj_lostself@163.com/QSTestPodsLibrary.git', :tag => s.version.to_s }
